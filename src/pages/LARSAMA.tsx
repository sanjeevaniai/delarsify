...
import { LogIn, Bot, LogOut, User, ArrowLeft } from 'lucide-react';
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="grid md:grid-cols-3 gap-6 mt-16">
                    ...
                    <Card className="p-6 text-center">
                        <Bot className="h-8 w-8 mx-auto mb-4 text-primary" />
                        <h4 className="font-semibold text-primary mb-2">24/7 Availability</h4>
                        <p className="text-sm text-muted-foreground">Access evidence-based guidance whenever you need it</p>
                    </Card>
                </div>
            </div>
        </div>
